    ...
    return (
      <div>
        ...
        <ul className="newsMenu">
          <li><a href="#" onClick={this.searchNewsAPI} name="top-headlines?sources=bbc-sport">Latest Sport News</a></li>
          <li><a href="#" onClick={this.searchNewsAPI} name="top-headlines?sources=football-italia">Football</a></li>
          <li><a href="#" onClick={this.searchNewsAPI} name="top-headlines?sources=espn-cric-info">Cricket</a></li>
          <li><a href="#" onClick={this.searchNewsAPI} name="top-headlines?sources=nfl-news">NFL</a></li>
        </ul>
