    ...
    return (
      <div>
        ...
        <ul className="newsMenu">
          ...
          <li><a href="#" onClick={this.searchNewsAPI} name="top-headlines?sources=breitbart-news">Politics</a></li>
          <li><a href="#" onClick={this.searchNewsAPI} name="everything?q=technology">Technology</a></li>
