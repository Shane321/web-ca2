...
// Initial News source
const defaultNewsSource = 'mashable';
    ...
    return (
      <div>
        ...
        <ul className="newsMenu">
          <li><a href="#" onClick={this.searchNewsAPI} name="top-headlines?sources=ign">Gaming</a></li>
          <li><a href="#" onClick={this.searchNewsAPI} name="everything?sources=the-lad-bible">Tabloids</a></li>
          <li><a href="#" onClick={this.searchNewsAPI} name="top-headlines?sources=mtv-news">Music</a></li>
          <li><a href="#" onClick={this.searchNewsAPI} name="top-headlines?sources=techcrunch">Technology</a></li>
        </ul>
